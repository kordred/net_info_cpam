  ...
  <Border Margin="14" CornerRadius="14" Background="#FFFFFF">
    ...
    <Grid>
      ...
      <StackPanel Grid.Row="1" Margin="20,14,20,8">
        ...
        <!-- Hostname -->
        <TextBlock Text="MACHINE" FontFamily="Consolas" FontSize="9" FontWeight="Bold" Margin="0,0,0,5">
          <TextBlock.Foreground><SolidColorBrush Color="#B0B8CC"/></TextBlock.Foreground>
        </TextBlock>
        <Border CornerRadius="8" Padding="14,11" Margin="0,0,0,14">
          ...
          <TextBlock Name="TxtHostname" FontFamily="Consolas" FontSize="15" FontWeight="Bold">
        ...
        <Border CornerRadius="8" Padding="14,12" Margin="0,0,0,14">
          ...
          <Grid>
            ...
            <StackPanel Grid.Column="0" Grid.Row="0">
              <TextBlock Text="IP LOCALE" FontFamily="Consolas" FontSize="9" FontWeight="Bold" Margin="0,0,0,3">
                <TextBlock.Foreground><SolidColorBrush Color="#B0B8CC"/></TextBlock.Foreground>
              </TextBlock>
            ...
            <StackPanel Grid.Column="1" Grid.Row="0">
              <TextBlock Text="MASQUE" FontFamily="Consolas" FontSize="9" FontWeight="Bold" Margin="0,0,0,3">
                <TextBlock.Foreground><SolidColorBrush Color="#B0B8CC"/></TextBlock.Foreground>
              </TextBlock>
              <TextBlock Name="TxtMask" FontFamily="Consolas" FontSize="14">
        ...
        <Border CornerRadius="8" Padding="14,12">
          ...
          <Grid>
            ...
            <Border Name="JigDot" Grid.Column="0" Width="40" Height="40" CornerRadius="20" Margin="0,0,12,0">
...
function Schedule-NextJig {
    ...
    $secs = $script:Rng.Next(5, 21)   # entre 5 et 20 secondes
...
$BtnClose.Add_Click({
    if ($script:JigTimer) { $script:JigTimer.Stop() }
    $window.Close()
})
